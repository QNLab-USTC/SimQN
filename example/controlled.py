from os import name
from qns.quantum import QuantumController
from qns.quantum.controller import ControllerProtocol
from qns.quantum import node
...
from qns.quantum import QuantumNode, QuantumController
...
ndp1 = QuantumNodeDistillationProtocol(n1, threshold=0.9, under_controlled= True)
...
ndp2 = QuantumNodeDistillationProtocol(n2, threshold=0.9, under_controlled= True)
...
ndp3 = QuantumNodeDistillationProtocol(n3, threshold=0.9, under_controlled= True)
...
ndp4 = QuantumNodeDistillationProtocol(n4, threshold=0.9, under_controlled= True)
...
controller = QuantumController(nodes = [n1, n2, n3, n4], links= [c1, c2, c3], name = "controller")
distillation_schema = [(n1, n2), (n1, n3), (n1, n4), (n2, n3), (n2,n4), (n3,n4)]
swapping_schema = {
    n2: ([n1],[n3, n4]),
    n3: ([n1,n2],[n4]),
}
ccp = ControllerProtocol(controller, delay = 0.25, distillation_schema= distillation_schema, distillation_threshold= 0.9,swapping_schema= swapping_schema)
