...
cdef class Time(object):
    cdef public int accuracy
    cdef public int time_slot

    def __cinit__(self, int time_slot = 0, double sec = 0.0, int accuracy = default_accuracy):
        '''
    ...
    def sec(self) -> float:
        ...
        '''
        return <double> self.time_slot / self.accuracy
